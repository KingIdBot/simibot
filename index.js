const  XBOT = 'SIMI BOT'; // Nama Bot Whatsapp
const instagram = 'TIDAK TERSEDIA'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+18313535216'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://youtube.com/channel/UCHK9gIokua2zkYKYTbqAwMQ'; 
...
conn.sendMessage(id, 'Owner BOT SIMI wa.me/18313535216' ,MessageType.text);
}
else if (text == 'simi'){
conn.sendMessage(id, 'Aku BOT nya MrKing' ,MessageType.text);
}
else if (text == 'audio'){
